...
------------------------------------
 ...
 The application was developed with MongoDB as target DB. 

PostMan collection for the Application
------------------------------------

 The PostMan collection is stored inside the src/test/resources folder. 
